...
const Questions = () => {
  return (
    <>
      ...
      <Typography variant="subtitle1" fontStyle='bold' fontWeight="700"mt={3} mb={3}>
        Facing error in writing smart contracts and integrating in Hardhat
        <Typography variant="subtitle1" mb={1}>
          Upvote DownVote Answers(5) <span style={{ marginLeft: "61%" }}>12 March 2022 by Alex Patel</span>
          {/* <Typography>12 March 2022 by Alex Patel</Typography> */}
        </Typography>
        <Box sx={{ borderBottom: 1, width: 1110, color: "#E5E5E5" }}></Box>
      </Typography>
      <Typography variant="subtitle1" fontStyle='bold' fontWeight="700" mb={3}>
        Facing error in writing smart contracts and integrating in Hardhat
        <Typography variant="subtitle1" mb={1}>
          Upvote DownVote Answers(5)<span style={{ marginLeft: "61%" }}>12 March 2022 by Alex Patel</span>
        </Typography>
      ...
      <Typography variant="subtitle1" fontStyle='bold' fontWeight="700" mb={2}>
        Facing error in writing smart contracts and integrating in Hardhat
        <Typography variant="subtitle1" mb={1}>
          Upvote DownVote Answers(5)<span style={{ marginLeft: "61%" }}>12 March 2022 by Alex Patel</span>
        </Typography>
